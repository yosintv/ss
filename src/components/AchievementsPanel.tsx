...
export function AchievementsPanel({ open, onClose }: Props): JSX.Element | null {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end justify-center bg-black/60 backdrop-blur-sm p-0 sm:items-center sm:p-4" onClick={onClose}>
      <div
        className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-t-2xl sm:rounded-3xl border border-zinc-200 bg-white p-5 text-zinc-900 shadow-2xl sm:p-7 animate-[slideUp_0.22s_ease-out] sm:animate-[modalIn_0.18s_ease-out]"
