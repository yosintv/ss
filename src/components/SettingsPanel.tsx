...
export function SettingsPanel(props: Props): JSX.Element | null {
  ...
  return (
    <div className="fixed inset-0 z-30 bg-black/50 backdrop-blur-sm" onClick={props.onClose}>
      <aside
        className="fixed inset-x-0 bottom-0 max-h-[92vh] overflow-y-auto rounded-t-2xl bg-gradient-to-b from-zinc-50 to-white p-4 text-zinc-900 shadow-2xl sm:inset-x-auto sm:right-0 sm:top-0 sm:bottom-auto sm:h-full sm:max-h-full sm:w-full sm:max-w-sm sm:rounded-none animate-[slideUp_0.22s_ease-out] sm:animate-[slideInRight_0.22s_ease-out]"
